...
export class modelOrganization1657939312324 implements MigrationInterface {
  name = 'modelOrganization1657939312324';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "organization" ("created_at" timestamp NOT NULL DEFAULT current_timestamp(), "updated_at" timestamp NOT NULL DEFAULT current_timestamp(), "id" INT DEFAULT nextval('"organization_id_seq"') NOT NULL, "name" varchar(500) NOT NULL, "status" int8 NOT NULL, CONSTRAINT "PK_472c1f99a32def1b0abb219cd67" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`CREATE SEQUENCE "tribe_id_seq"`);
    await queryRunner.query(
